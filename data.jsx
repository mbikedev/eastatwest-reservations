...
const MENU = {
  sets: [
    { id: 'menu_eaw',    name: 'Menu East at West',
      desc: {
        en: 'Selection of house specialties — hummus, moutabal, fattoush, kibbeh, chicken taouk, lamb kafta',
        fr: 'Sélection de spécialités maison — houmous, moutabal, fattouche, kibbeh, taouk de poulet, kafta d’agneau',
        nl: 'Selectie van huisspecialiteiten — hummus, moutabal, fattoush, kibbeh, kip taouk, lams kafta',
      },
      price: 67.50, spice: false, tags: [], img: 'set1', photo: 'img/menu-east-at-west.webp' },
    { id: 'menu_lazeez', name: 'Menu Lazeez',
      desc: {
        en: 'Mixed menu of our favorites — assorted hot & cold mezzes, kibbeh, mixed grill skewer',
        fr: 'Menu mixte de nos favoris — mezzes chauds et froids assortis, kibbeh, brochette mixte',
        nl: 'Mix-menu van onze favorieten — warme & koude mezze, kibbeh, gemengde grillspies',
      },
      price: 65.50, spice: false, tags: [], img: 'set2', photo: 'img/menu-lazeez.webp' },
    { id: 'menu_sahten', name: 'Menu Sahten',
      desc: {
        en: 'Generous menu to share — large plate of mezzes, kafta, taouk and kibbeh',
        fr: 'Menu généreux à partager — grande assiette de mezzes, kafta, taouk et kibbeh',
        nl: 'Royaal deelmenu — grote schotel mezze, kafta, taouk en kibbeh',
      },
    ...
    { id: 'menu_vegan',  name: 'Menu Vegan', name_fr: 'Menu Végan', name_nl: 'Menu Vegan',
      desc: {
        en: 'Vegan menu with assorted mezzes — hummus, moutabal, warak enab, falafel, batata harra, manaqish',
        fr: 'Menu végan avec mezzes assortis — houmous, moutabal, warak enab, falafel, batata harra, manaqish',
        nl: 'Vegan menu met diverse mezze — hummus, moutabal, warak enab, falafel, batata harra, manaqish',
      },
  ...
  mezze: [
    ...
    { id: 'muhamara',   name: 'Muhamara',
      desc: {
        en: 'Spicy red pepper and walnut dip with pomegranate molasses',
        fr: 'Tartinade épicée au poivron rouge et noix, mélasse de grenade',
        nl: 'Pittige dip van rode paprika en walnoot met granaatappelmelasse',
      },
      price: 8.00, spice: true,  tags: ['v'], img: 'm3', photo: 'img/mouhamara.webp' },
    { id: 'iche',       name: 'Iche',
      desc: {
        en: 'Traditional Armenian bulgur salad with herbs and vegetables',
        fr: 'Salade arménienne traditionnelle au boulgour, herbes et légumes',
        nl: 'Traditionele Armeense bulgursalade met kruiden en groenten',
      },
      price: 7.50, spice: false, tags: ['v'], img: 'm4', photo: 'img/iche.webp' },
    { id: 'warak_enab', name: 'Warak Enab',
      desc: {
        en: 'Stuffed grape leaves with rice, herbs and vegetables',
        fr: 'Feuilles de vigne farcies au riz, herbes et légumes',
        nl: 'Gevulde wijnbladeren met rijst, kruiden en groenten',
      },
      price: 7.00, spice: false, tags: ['v','gf'], img: 'm5', photo: 'img/warak-enab.webp' },
    { id: 'makdous',    name: 'Makdous',
      desc: {
        en: 'Baby eggplants stuffed with walnuts, garlic and peppers in olive oil',
        fr: 'Aubergines bébés farcies aux noix, ail et poivrons à l’huile d’olive',
        nl: 'Baby-aubergines gevuld met walnoot, knoflook en paprika in olijfolie',
      },
    ...
    { id: 'mousaka',    name: 'Mousaka',
      desc: {
        en: 'Traditional layered dish with eggplant, ground meat, and béchamel sauce',
        fr: 'Plat traditionnel en couches : aubergine, viande hachée et béchamel',
        nl: 'Traditioneel gelaagd gerecht met aubergine, gehakt en béchamelsaus',
      },
      price: 7.50, spice: false, tags: [], img: 'm8', photo: 'img/mousaka.webp' },
  ],
  hot: [
    { id: 'grilled_cheese', name: 'Grilled Cheese', name_fr: 'Fromage grillé', name_nl: 'Geroosterde kaas',
      desc: {
        en: 'Traditional grilled cheese with Mediterranean herbs',
        fr: 'Fromage grillé traditionnel aux herbes méditerranéennes',
        nl: 'Traditionele geroosterde kaas met mediterrane kruiden',
      },
    ...
    { id: 'arayes',     name: 'Arayes Cheese', name_fr: 'Arayes au fromage', name_nl: 'Arayes met kaas',
      desc: {
        en: 'Grilled pita bread stuffed with melted cheese and herbs',
        fr: 'Pita grillé farci au fromage fondu et aux herbes',
        nl: 'Gegrilde pita gevuld met gesmolten kaas en kruiden',
      },
    ...
    { id: 'batata',     name: 'Batata Harra',
      desc: {
        en: 'Spicy fried potatoes with garlic, coriander and chili',
        fr: 'Pommes de terre sautées épicées à l’ail, coriandre et piment',
        nl: 'Pittige gebakken aardappel met knoflook, koriander en chili',
      },
      price: 7.50, spice: true,  tags: ['v','gf'], img: 'g8', photo: 'img/batata-hara.webp' },
    { id: 'foul',       name: 'Foul Moudamas',
      desc: {
        en: 'Traditional fava beans stew with garlic, lemon and olive oil',
        fr: 'Ragoût traditionnel de fèves à l’ail, citron et huile d’olive',
        nl: 'Traditionele tuinbonenstoof met knoflook, citroen en olijfolie',
      },
      price: 8.00, spice: false, tags: ['v','gf'], img: 'g7', photo: 'img/foul-moudamas.webp' },
    { id: 'falafel',    name: 'Falafel (2pcs)', name_fr: 'Falafel (2 pcs)', name_nl: 'Falafel (2 st.)',
      desc: {
        ...
        nl: 'Gefrituurde balletjes van kikkererwtenpuree met tahinisaus',
      },
      price: 4.00, spice: false, tags: ['v'], img: 'g6', photo: 'img/falafel-salad.webp' },
    { id: 'kibbeh',     name: 'Kibbeh (2pcs)', name_fr: 'Kibbeh (2 pcs)', name_nl: 'Kibbeh (2 st.)',
      desc: {
        en: 'Fried bulgur croquettes stuffed with minced beef, onion and walnuts',
        fr: 'Croquettes de boulgour farcies au bœuf haché, oignon et noix',
        nl: 'Gefrituurde bulgurkroketten gevuld met rundergehakt, ui en walnoot',
      },
    ...
    { id: 'chicken_liver', name: 'Chicken Liver', name_fr: 'Foie de volaille', name_nl: 'Kippenlevertjes',
      desc: {
        ...
        fr: 'Foie de volaille cuit à l’oignon et aux épices, servi avec sauce grenade',
  ...
  lunch: [
    { id: 'kebab_dish',    name: 'Kebab Dish', name_fr: 'Plat kebab', name_nl: 'Kebabschotel',
      desc: {
        en: 'Grilled kebab served with rice, grilled vegetables and garlic sauce',
        fr: 'Brochette de kebab grillée, riz, légumes grillés et sauce à l’ail',
        nl: 'Gegrilde kebab met rijst, gegrilde groenten en knoflooksaus',
      },
      price: 19.00, spice: false, tags: [], img: 'l1', photo: 'img/kebab-dish.webp' },
    { id: 'toshka',        name: 'Toshka',
      desc: {
        en: 'Traditional dish with yogurt sauce and spiced meat',
        fr: 'Plat traditionnel à la sauce yaourt et viande épicée',
        nl: 'Traditioneel gerecht met yoghurtsaus en gekruid vlees',
      },
      price: 20.80, spice: false, tags: [], img: 'l2', photo: 'img/sujuk.webp' },
    { id: 'falafel_plate', name: 'Falafel Plate', name_fr: 'Assiette de falafel', name_nl: 'Falafelschotel',
      desc: {
    ...
    { id: 'sujuk_dish',    name: 'Sujuk Dish', name_fr: 'Plat sujuk', name_nl: 'Sujukschotel',
      desc: {
    ...
    { id: 'chefs_dish',    name: 'Chef’s Dish', name_fr: 'Plat du chef', name_nl: 'Gerecht van de chef',
      desc: {
        en: 'Mixed grill platter with various meats and traditional sides',
        fr: 'Plateau de grillades variées avec accompagnements traditionnels',
        nl: 'Gemengd grillbord met diverse vleessoorten en traditionele bijgerechten',
      },
    ...
    { id: 'mix_grill',     name: 'Mix Grill',
      ...
      price: 18.00, spice: false, tags: [], img: 'l6', photo: 'img/mix-grill.webp' },
    { id: 'shish_taouk',   name: 'Shish Taouk',
      desc: {
      ...
      price: 19.00, spice: false, tags: ['gf'], img: 'l7', photo: 'img/shish-taouk.webp' },
  ],
  sandwiches: [
